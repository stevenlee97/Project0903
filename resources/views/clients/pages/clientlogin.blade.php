            ...
            <div class="row">
                <div class="col-sm-2"></div>
                    <div class="col-sm-8">
                      <div class="card">
                        <div class="card-body">
                          <h3 class="card-title" style="text-align:center">LOGIN PAGE</h3>
                        <br/>
                          <form class="form-signin" method="post" action="{{route('postclientlogin')}}">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <button style="" type="submit" class="btn btn-primary">Sign in</button>
                                    </div>
                                    
                                </div>
                                <div style="float:right"><a href="#">Forgotten Password?</a></div>
                                <br/>
                            <div style="float:right">Don't have account? <a href="{{route('getclientregister')}}">Sign up</a> here</div>
                            </form>
                        </div>
                      </div>
                    </div>
