...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/client/styles/blog_single_styles.css">
	<link rel="stylesheet" type="text/css" href="assets/client/styles/blog_single_responsive.css">
...
<body>
            ...
            <div class="row">
                <div class="col-sm-2"></div>
                    <div class="col-sm-8">
                      <div class="card">
                        <div class="card-body">
                          <h3 class="card-title" style="text-align:center">REGISTER PAGE</h3>
                        <br/>
                          <form  class="form-signin" method="post" action="{{route('postclientregister')}}">
                            @csrf
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="fullname" id="fullname" placeholder="Please enter your full name" required>
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" name="birthdate" id="birthdate" placeholder="Please enter your birthdate" required>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="phone" id="phone" placeholder="Please enter your phone"required>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="password" class="form-control" name="cfrpassword" id="cfrpassword" placeholder="Please enter your password again"required>
                                ...
                                <br/>
                            <div style="float:right">Already have account? <a href="{{route('getclientlogin')}}">Sign in</a> here</div>
                            </form>
                        </div>
                      </div>
                    </div>
	...
	<script src="assets/client/js/blog_single_custom.js"></script>
</body>
